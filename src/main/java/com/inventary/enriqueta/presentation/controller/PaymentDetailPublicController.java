...
@CrossOrigin(origins = "*")
@RestController
@RequestMapping("/public/payment-details${api.version}")
public class PaymentDetailPublicController {

    private final PaymentDetailService paymentDetailService;

    @Autowired
    public PaymentDetailPublicController(PaymentDetailService paymentDetailService) {
